...
BOOL CFileManagerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFileManagerDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CTotalTabView));
	if (!pDocTemplate)
		return FALSE;
...
void CFileManagerApp::SaveCustomState()
{
}
...
CString CFileManagerApp::LoadString(unsigned int ID)
{
	CString strCustomize("");
	strCustomize.LoadString(ID);
	return strCustomize;
}